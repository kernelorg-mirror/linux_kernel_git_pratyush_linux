...
/**
 * kho_array_unpreserve() - KHO-unpreserve all pages of the array
 * @ka: KHO array.
 *
 * Opposite of kho_array_preserve(). Marks all pages of the array to not be
 * preserved across KHO.
 *
 * Return: 0 on success, -errno on failure.
 */
...
/**
 * ka_iter_init_write() - Restore KHO array and initialize iterator for reading.
 * @iter: KHO array iterator.
 * @ka: KHO array.
 *
 ...
 */
static inline bool ka_iter_end(struct ka_iter *iter)
{
 ...
 */
static inline void *ka_iter_getentry(struct ka_iter *iter)
{
